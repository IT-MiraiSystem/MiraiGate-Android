...
class MainActivity_NotUsed_OldSignIn : ComponentActivity() {
...
@Composable
fun Greeting_NotUsed_OldSignIn(name: String, modifier: Modifier = Modifier) {
    Text(
        text = "Hello $name!",
        modifier = modifier
    )
...
@Composable
fun GreetingPreview_NotUsed_OldSignIn() {
    ITmiraiAndroidAppTheme {
        Greeting("Android")
    }
}
